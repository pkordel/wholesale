...
CREATE TABLE "orders" ("id" INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, "user_id" integer, "number" varchar(15), "item_total" decimal(8,2) DEFAULT 0.0 NOT NULL, "total" decimal(8,2) DEFAULT 0.0 NOT NULL, "created_at" datetime, "updated_at" datetime, "state" varchar(255), "token" varchar(255), "adjustment_total" decimal(8,2) DEFAULT 0.0 NOT NULL, "credit_total" decimal(8,2) DEFAULT 0.0 NOT NULL, "completed_at" datetime, "currency" varchar(255));
CREATE TABLE "payment_methods" ("id" INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, "type" varchar(255), "name" varchar(255), "description" text, "active" boolean DEFAULT 't', "environment" varchar(255) DEFAULT 'development', "created_at" datetime, "updated_at" datetime, "deleted_at" datetime DEFAULT NULL, "display" varchar(255) DEFAULT NULL);
...
CREATE TABLE "tax_categories" ("id" INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, "name" varchar(255), "description" varchar(255), "created_at" datetime, "updated_at" datetime, "is_default" boolean DEFAULT 'f');
...
CREATE TABLE "taxons" ("id" INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, "taxonomy_id" integer NOT NULL, "parent_id" integer, "position" integer DEFAULT 0, "name" varchar(255) NOT NULL, "created_at" datetime, "updated_at" datetime, "permalink" varchar(255), "lft" integer, "rgt" integer, "icon_file_name" varchar(255), "icon_content_type" varchar(255), "icon_file_size" integer, "icon_updated_at" datetime, "description" text);
...
CREATE TABLE "variants" ("id" INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, "product_id" integer, "sku" varchar(255) DEFAULT '' NOT NULL, "price" decimal(8,2) NOT NULL, "weight" decimal(8,2), "height" decimal(8,2), "width" decimal(8,2), "depth" decimal(8,2), "deleted_at" datetime, "is_master" boolean DEFAULT 'f', "count_on_hand" integer DEFAULT 0 NOT NULL, "cost_price" decimal(8,2) DEFAULT NULL, "wholesale_price" decimal(8,2), "price_usd" decimal(8,2), "wholesale_price_usd" decimal(8,2));
...
CREATE INDEX "index_addresses_on_firstname" ON "addresses" ("firstname");
CREATE INDEX "index_addresses_on_lastname" ON "addresses" ("lastname");
...
CREATE INDEX "index_checkouts_on_bill_address_id" ON "checkouts" ("bill_address_id");
CREATE INDEX "index_checkouts_on_order_id" ON "checkouts" ("order_id");
...
CREATE INDEX "index_shipments_on_number" ON "shipments" ("number");
...
INSERT INTO schema_migrations (version) VALUES ('20091012070640');

INSERT INTO schema_migrations (version) VALUES ('20100619104410');

INSERT INTO schema_migrations (version) VALUES ('20100602161247');

INSERT INTO schema_migrations (version) VALUES ('20100602161521');

INSERT INTO schema_migrations (version) VALUES ('20100706160918');